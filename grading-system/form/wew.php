                ...
                <div class=" details ID">
                            ...
                            <div class="fields">
                                ...
                                <div class=" input-field">
                                    ...
                                    <input type="text" name="GUARDIAN" value="<?php echo $user['GUARDIAN']; ?>">
                                </div>

                                <div class="input-field">
                                    <label>Guardian Contact Number</label>
                                    <input type="text" name="GUARD_CONTACT"
                                        value="<?php echo $user['GUARD_CONTACT']; ?>">
                                </div>

                                <div class="input-field">
                                    <label>Guardian Address</label>
                                    <input type="text" name="GUARD_ADDRESS"
                                        value="<?php echo $user['GUARD_ADDRESS']; ?>">
                                </div>
                            </div>
                        </div>
                        <button class="sumbit" style="transform: translateX(323px);" type="submit" value="Update">
